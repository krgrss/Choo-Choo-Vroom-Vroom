...
if __name__ == "__main__":
    # Load the enriched data produced by the feature engineering pipeline.
    enriched_df = pd.read_csv("enriched_data.csv", parse_dates=["timestamp"])
    print("Enriched data loaded. Shape:", enriched_df.shape)
